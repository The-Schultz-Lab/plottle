...
This script demonstrates how to use the plotting-helper io module
...
def example_pickle_operations():
    ...
    experiment_data = {
        ...
        "metadata": {"date": "2026-02-12", "instrument": "DSC-100"},
    }
...
def example_numpy_operations():
    ...
    data_dict = {"coordinates": coordinates, "energies": energies, "timestep": np.arange(100)}
...
def example_universal_loader():
    ...
    formats = {
        ...
        "csv": (pd.DataFrame({"x": [1, 2, 3], "y": [4, 5, 6]}), "examples/data/auto_test.csv"),
    }
...
def main():
    ...
    print("plotting-helper package for scientific computing.\n")
